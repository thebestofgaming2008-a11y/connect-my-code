...
const DEFAULT_SECTIONS: SiteSection[] = [
  { id: 'default-hero', page: 'home', section_key: 'hero', title: 'Authentic Islamic Books from Trusted Publishers', subtitle: 'Every book verified and sourced directly from authorized publishers. No unauthorized prints, no compromises on authenticity.', content: { cta_text: 'Browse Authentic Books', cta_link: '/shop' }, sort_order: 0, is_visible: true, created_at: null, updated_at: null },
