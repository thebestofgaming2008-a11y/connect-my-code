...
const DEFAULT_SECTIONS: SiteSection[] = [
  { id: 'default-hero', page: 'home', section_key: 'hero', title: 'Authentic Islamic Books from Trusted Publishers', subtitle: 'Classical texts to contemporary works. Every book sourced from verified publishers. Fast shipping across India.', content: { cta_text: 'Shop Authentic Books Now', cta_link: '/shop' }, sort_order: 0, is_visible: true, created_at: null, updated_at: null },
